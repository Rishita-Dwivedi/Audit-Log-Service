...
class AuditEventCreationTest extends AbstractApiIntegrationTest {
    ...
    void createsEventSuccessfully() {
        ...
        ResponseEntity<AuditEventResponse> response = restTemplate.postForEntity(
                baseUrl("/audit/events"), request, AuditEventResponse.class);
    ...
    void rejectsRequestMissingRequiredFields() {
        ...
        ResponseEntity<ErrorResponse> response = restTemplate.postForEntity(
                baseUrl("/audit/events"), request, ErrorResponse.class);
