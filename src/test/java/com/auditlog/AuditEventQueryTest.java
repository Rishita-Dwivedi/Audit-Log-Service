...
class AuditEventQueryTest extends AbstractApiIntegrationTest {
    ...
    void filtersByActorId() {
        ...
        AuditEventPageResponse response = get("/audit/events?actorId=user-1", AuditEventPageResponse.class);
    ...
    void filtersByResourceTypeAndResourceId() {
        ...
        AuditEventPageResponse response = get("/audit/events?resourceType=ACCOUNT&resourceId=acct-2", AuditEventPageResponse.class);
    ...
    void filtersByEventType() {
        ...
        AuditEventPageResponse response = get("/audit/events?eventType=PERMISSION_GRANTED", AuditEventPageResponse.class);
    ...
    void filtersByTimeRange() {
        ...
        AuditEventPageResponse response = get(
                "/audit/events?from=2026-03-01T00:00:00Z&to=2026-12-31T00:00:00Z", AuditEventPageResponse.class);
    ...
    void paginatesUsingCursor() {
        ...
        AuditEventPageResponse firstPage = get("/audit/events?pageSize=2", AuditEventPageResponse.class);
        assertThat(firstPage.items()).hasSize(2);
        assertThat(firstPage.hasMore()).isTrue();

        AuditEventPageResponse secondPage = get(
                "/audit/events?pageSize=2&afterSequenceNo=" + firstPage.nextCursor(), AuditEventPageResponse.class);
